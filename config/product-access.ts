...
export const PRODUCT_ACCESS_RULES: ProductAccessRule[] = [
  // ── Memberships ─────────────────────────────────────────
  {
    ...
    allowedLevels: null,
    isProvisional: true,
    provisionalNote: "Exact style/class-per-week limits pending academy confirmation",
  },
  {
    productId: "p-silver",
    allowedClassTypes: ["class"],
  ...
  },
  {
    ...
    allowedLevels: null,
    isProvisional: true,
    provisionalNote: "Treated as all-styles unlimited; confirm scope with academy",
  },
  ...
  // ── Yoga ────────────────────────────────────────────────
  {
    ...
    allowedLevels: null,
    isProvisional: true,
    provisionalNote: "Yoga classes not yet in schedule; style ID TBD",
  },
  {
