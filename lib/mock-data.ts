...
export const DANCE_STYLES: MockDanceStyle[] = [
  ...
  { id: "ds-3", name: "Bachata Partnerwork", description: "Emphasis on turn patterns, lead-follow techniques, and intricate partner combinations in Bachata.", requiresRoleBalance: true },
