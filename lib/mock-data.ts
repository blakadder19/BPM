...
export const PRODUCTS: MockProduct[] = [
  ...
  { id: "p-mem-bronze-std", name: "Bronze Standard Membership", description: "4 classes per month (Yoga & Kids Hip Hop).", longDescription: "4 classes per month for Yoga and Kids Hip Hop. Cash or card with auto-renewal.", productType: "membership", priceCents: 6500, totalCredits: null, durationDays: null, styleName: "Yoga & Kids Hip Hop", allowedLevels: null, isActive: true, isProvisional: false, notes: null, validityDescription: "Per term", creditsModel: "unlimited", termBound: true, recurring: true, classesPerTerm: 4, autoRenew: true, benefits: BRONZE_BENEFITS, allowedStyleIds: STANDARD_MEM_IDS, allowedStyleNames: STANDARD_MEM_NAMES, spanTerms: null },
  ...
  { id: "p-mem-silver-std", name: "Silver Standard Membership", description: "8 classes per month (Yoga & Kids Hip Hop).", longDescription: "8 classes per month for Yoga and Kids Hip Hop. Cash or card with auto-renewal.", productType: "membership", priceCents: 12000, totalCredits: null, durationDays: null, styleName: "Yoga & Kids Hip Hop", allowedLevels: null, isActive: true, isProvisional: false, notes: null, validityDescription: "Per term", creditsModel: "unlimited", termBound: true, recurring: true, classesPerTerm: 8, autoRenew: true, benefits: SILVER_BENEFITS, allowedStyleIds: STANDARD_MEM_IDS, allowedStyleNames: STANDARD_MEM_NAMES, spanTerms: null },
  ...
  { id: "p-mem-gold-std", name: "Gold Standard Membership", description: "12 classes per month (Yoga & Kids Hip Hop).", longDescription: "12 classes per month for Yoga and Kids Hip Hop. Cash or card with auto-renewal.", productType: "membership", priceCents: 17000, totalCredits: null, durationDays: null, styleName: "Yoga & Kids Hip Hop", allowedLevels: null, isActive: true, isProvisional: false, notes: null, validityDescription: "Per term", creditsModel: "unlimited", termBound: true, recurring: true, classesPerTerm: 12, autoRenew: true, benefits: GOLD_BENEFITS, allowedStyleIds: STANDARD_MEM_IDS, allowedStyleNames: STANDARD_MEM_NAMES, spanTerms: null },
