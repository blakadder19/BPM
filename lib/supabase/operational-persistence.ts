...
function rowToAuditEntry(r: Record<string, unknown>): FinanceAuditEntry {
  return {
    ...
    performedByUserId: (r.performed_by_user_id as string) ?? null,
    performedByEmail: (r.performed_by_email as string) ?? null,
...
function auditEntryToRow(e: FinanceAuditEntry) {
  return {
    ...
    performed_by_email: e.performedByEmail,
    performed_by_name: e.performedByName,
    performed_at: e.performedAt ?? e.createdAt,
    detail: e.detail,
